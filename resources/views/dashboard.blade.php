<x-app-layout>
    ...
    <div class="bg-blue-500  border-blue-500 text-green-700 p-4 rounded-md my-4 mx-6">
        <div class="flex justify-center">
            <svg class="w-6 h-6 mr-4 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                <path
                    d="M9 2a7 7 0 100 14 7 7 0 000-14zM7.707 9.707a1 1 0 01-1.414 0L5.293 8.707a1 1 0 011.414-1.414L7 8.586l3.293-3.293a1 1 0 111.414 1.414L7.707 9.707z"/>
            </svg>
            <div>
